  ...
  return (
    <section className="container images flex gap-5 mb-[100px] flex-wrap md:flex-nowrap">
      <div className="w-full md:w-1/2">
        <img className="h-full w-full" src="./imgs/Playstation.png" alt="" />
      </div>
      <div className="flex flex-col gap-5 md:gap-[30px] w-full md:w-1/2">
        ...
        <div className="flex gap-5 h-[calc(100%_-_314px)] flex-wrap xs:flex-nowrap">
          <div className="grow">
            <img className="w-full h-full " src="./imgs/Speakers.png" alt="" />
          </div>
          <div className="grow">
            <img className="w-full h-full " src="./imgs/perfume.png" alt="" />
          </div>
        </div>
      </div>
    </section>
