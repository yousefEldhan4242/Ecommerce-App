...
const ProductCard = ({
  ...
  const renderStars = () => {
    ...
    for (let i = 0; i < 5; i++) {
      if (i < filledStars) {
        stars.push(<img src="../../imgs/starpng.png" key={i} />);
      } else if (i === filledStars && halfStar) {
        // Create Half Star
        stars.push(<img src="../../imgs/star-half-filled.png" key={i} />);
      } else {
        // reate Empty Star
        stars.push(<img src="../../imgs/empty-star.png" key={i} />);
      }
    }
    return stars;
  };
          ...
          <div className="relative flex items-center justify-center h-[200px] bg-[#f5f5f5] overflow-hidden rounded">
            ...
            <div className="absolute top-[10px] right-[10px] flex flex-col gap-2">
              ...
              {!isInWhishList && (
                ...
                >
                  <img src="./imgs/Fill Heart.png" alt="" />
                </div>
              )}
            ...
            >
              {isInWhishList && (
                <span className="mr-2">
                  <ShoppingCartOutlinedIcon ref={cartIconRef} />
                </span>
              )}
              Add To Cart
            </div>
