...
const ProductDetails = () => {
  ...
  let whishListState = useSelector((state) => state.whishList);
  let [isInWhishList, setIsInWhishList] = useState(false);
  let [quantity, setQuantity] = useState(1);

  const renderStars = () => {
    const filledStars = Math.floor(chosenProduct.rating); // number of filled stars
    const halfStar = chosenProduct.rating % 1 !== 0; // true if there is half stars
    const stars = [];
            ...
            <div className="flex gap-2 items-center">
              <div
                className={`w-[18px] h-[18px] ${
                  chosenProduct.color == "black"
                    ? "bg-[black]"
                    : chosenProduct.color == "#f91313"
                    ? "bg-[#f91313]"
                    : chosenProduct.color == "#eeff61"
                    ? "bg-[#eeff61]"
                    : chosenProduct.color == "#184a47"
                    ? "bg-[#184a47]"
                    : ""
