...
const SignUpAndLogIn = ({ isInLogIn }) => {
  ...
  const emailOrPhoneNumberRef = useRef();
  const emailOrPhoneNumberInputRef = useRef();
  const passwordRef = useRef();
  const passwordInputRef = useRef();
  const submitBtnRefSignUp = useRef();
  const submitBtnRefLogIn = useRef();
